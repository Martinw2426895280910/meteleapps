    ...
    <footer className="bg-black border-t border-lime-500/30 px-4 pt-8 pb-28 text-center">
      <div className="max-w-md mx-auto space-y-4">
        ...
        <div className="bg-neutral-950 border-2 border-lime-400/50 rounded-3xl p-4 my-3 shadow-[0_0_25px_rgba(16,232,54,0.2)]">
          ...
          <a
            href={createWhatsAppUrl("¡Hola METELE APPS! 🔥 Quiero información para digitalizar mi negocio con una Mini App con la Promoción activa.")}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full relative overflow-hidden inline-flex items-center justify-center gap-2 bg-[#25D366] text-black font-heading font-black text-sm sm:text-base py-3.5 px-4 rounded-2xl shadow-[0_0_25px_rgba(37,211,102,0.8)] btn-pulsing-intense my-2 group transition-all"
          >
            <div className="absolute inset-0 w-1/3 h-full bg-white/40 skew-x-[-25deg] animate-shimmer pointer-events-none" />
            <MessageCircle className="w-5 h-5 fill-black text-black group-hover:scale-110 transition-transform" />
            <span className="tracking-wider">HACE CLICKS AHORA !! Promoción 🔥</span>
          </a>
